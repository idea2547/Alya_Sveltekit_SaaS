	...
	<div class="mx-auto px-4 sm:px-12 xl:max-w-6xl xl:px-0">
		<div class="relative">
			...
			<p class="text-center text-3xl sm:text-3xl lg:text-left lg:text-3xl">
				Utilize pocketbase as back-end <br /> Stripe as payment gateway
			</p>
			...
			<div class="relative gap-12 lg:flex">
				<div class="text-center sm:mx-auto sm:w-11/12 md:mt-12 md:w-4/5 lg:mt-0 lg:mr-auto lg:w-6/12 lg:text-left space-y-5">
					...
					<div class="flex justify-center items-center">
						<button class="flex flex-col space-y-2 sm:flex-row md:w-max lg:space-y-0">
							<a href="/createsoundplus" class="relative flex h-9 w-full justify-center before:absolute before:inset-0 before:rounded-full before:bg-primary before:transition-transform before:duration-300 hover:before:scale-105 active:duration-75 active:before:scale-125">
				...
				<div class="rounded-3xl mt-12 overflow-hidden sm:mt-12 sm:w-full lg:-mt-12 lg:w-6/12 anim-float-card">			
